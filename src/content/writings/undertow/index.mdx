...
10. [Current takeaway](#current-takeaway)
11. [Closing](#closing)
...
> Undertow is a controlled way to generate hidden tool-use worlds where state tracking, recovery, repeated calls, stale observations, constraint failures, timeouts, and metric disagreement can be measured separately.
...
The current experiments are not the final answer. They are a first pass at making the question concrete enough to debug.
