...
8. [What I learned from the traces](#what-i-learned-from-the-traces)
9. [Current takeaway](#current-takeaway)
10. [What I would change next](#what-i-would-change-next)
...
<a id="what-i-learned-from-the-traces"></a>
...
<a id="what-i-would-change-next"></a>
