...
<div style={{textAlign: "center"}}>
  ...
  <p><em>Primary reward on the cleaner rerun. Same 2×2, two very different benchmark families.</em></p>
</div>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  <thead>
    <tr>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "left" }}>Arm</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Reward / Judge YES</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Avg task metric</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.9667</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6396</strong></td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.8667</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6525</strong></td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.7000</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5351</strong></td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6667</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4368</strong></td>
    </tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  <thead>
    <tr>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "left" }}>Arm</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Solved rate</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Judge YES</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5000</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6333</strong></td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4333</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.3333</strong></td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5333</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.7333</strong></td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score</code></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5667</strong></td>
      <td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.8667</strong></td>
    </tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  ...
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.7000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6333</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__mem_repl_files</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5667</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5667</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion__mem_repl_files</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4667</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4667</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  <thead>
    <tr>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "left" }}>Arm</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Reward</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.3000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.2000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__mem_repl_files</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.2000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.1000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion__mem_repl_files</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.1000</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  ...
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion__chat_no_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6333</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score__chat_system_reinject</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6333</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  ...
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion__rlm_skill_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5333</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__rlm_skill_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5667</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  ...
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion__chat_system_reinject</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score__chat_no_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score__chat_system_reinject</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion__chat_no_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.3000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion__rlm_skill_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.3000</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__rlm_skill_file</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.2000</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  <thead>
    <tr>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "left" }}>Arm</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Reward</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Tokens / rollout</th>
      <th style={{ border: "1px solid #6b7280", padding: "8px 10px", textAlign: "right" }}>Mean rollout time (min)</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.9667</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>149,192</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>32.2</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__single_criterion</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.7000</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>106,936</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>7.0</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.6667</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>119,868</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>4.8</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  ...
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5667</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>1,864,276</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>46.0</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__single_criterion</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5000</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>2,250,750</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>26.4</strong></td></tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: "collapse", width: "100%", margin: "12px 0" }}>
  ...
  <tbody>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>chat__total_score__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.7000</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>1,455,311</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>13.7</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__mem_repl_files</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.5667</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>1,399,685</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>16.3</strong></td></tr>
    <tr><td style={{ border: "1px solid #9ca3af", padding: "8px 10px" }}><code>rlm__total_score__mem_chat</code></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>0.4667</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>1,451,797</strong></td><td style={{ border: "1px solid #9ca3af", padding: "8px 10px", textAlign: "right" }}><strong>24.5</strong></td></tr>
  </tbody>
</table>
