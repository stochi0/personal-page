...
export const nowSection = {
  paragraphs: [
    "",
    "I like {Post-Training}, {Agents}, {RL} and {ML Systems}, During my RL residency at {Prime Intellect}, I built RL environments, long-context evals & experiments around Programatic Tool Calling & RLMs (Recursive Language Models).",
